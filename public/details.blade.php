...
<div class="fixed py-5 z-50 w-20 max-w-lg -translate-y-1/2 bg-white border border-gray-200 right-4 left-auto top-1/2 dark:bg-gray-700 dark:border-gray-600">
    <div class="grid h-full grid-cols-1 gap-y-5">
...
<section class="bg-gray-50">
    <section class="mx-auto max-w-screen-xl py-10">
        <span class="text-gray-400 text-sm">Home ></span> <span class="text-gray-400 text-sm">Products ></span> <span class="text-sm">Large rice cooker</span>
    </section>

    <section class="flex items-start gap-4 mx-auto max-w-screen-xl mb-3 ">
        <div class="sm:block w-4/6 bg-white">
   ...
   <div id="indicators-carousel" class="relative w-full" data-carousel="static">
    ...
    <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
        ...
        <div class="hidden duration-700 ease-in-out" data-carousel-item="active">
            <img src="Pan.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
        </div>
        <!-- Item 2 -->
        <div class="duration-700 ease-in-out" data-carousel-item>
            <img src="blender.WEBP" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
        </div>
        <!-- Item 3 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="air.WEBP" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
        </div>
        <!-- Item 4 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="pan.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
 ...
 <div class="my-3 text-sm font-medium text-gray-900 bg-white border  dark:bg-gray-700 dark:border-gray-600 dark:text-white">
        ...
        <div class="w-full bg-gray-50 px-9 py-3">
        <div class="flex flex-col">
        <div class="text-3xl">Large rice cooker</div>
        <div class="text-md mt-5 font-bold">What can be customized</div>
        
<ul class="max-w-md space-y-1 text-gray-500 mt-3 list-inside dark:text-gray-400">
...
<div class="flex mt-5">
<button type="submit" class="py-3 px-12 text-sm font-medium text-center text-white rounded-sm bg-red-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Get Quote</button>
<button type="submit" class="py-3 px-12 mx-2 text-sm border-2 font-medium text-center text-black rounded-sm border-green-500  sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">WhatsApp</button>
<div>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const items = carousel.getElementsByClassName("duration-700");
  ...
  function showSlide(slideIndex) {
    ...
    items[slideIndex].classList.remove("hidden");
  }
  ...
  // Set an interval to switch slides every 3 seconds (adjust as needed)
